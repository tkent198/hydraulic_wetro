%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TK's version of OB's tabletop2v2016.m (also edited Luke Barber)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Quick clean-up before implementing St Venant system.
...
%% Moor and res coupling location
...
%         legend({'Canal 1','Canal 2', 'Canal 3', 'Res/10'},'Location','southeast','fontsize',fs);
        ...
        subplot(2,2,2);
        plot([tijdo,tijd],[hro,hr(1)],'b','linewidth',1); hold on; %s=0
        plot([tijdo,tijd],[0.02,0.02],':r','linewidth',1); hold on; %h flood?
        plot([tijdo,tijd],[hrLo,hr(nxLc1)],'k','linewidth',1); hold on; %s=L_c1
...
%         sgtitle(['Wetropolis flood and rainfall demonstrator: t = ',num2str(tijd),' s'])
        ...
        plot(xxm,bx+hr,'-b','linewidth',2); hold off % river level
...
%         ntot = Tend/TimeUnit;
        ...
        subplot(2,1,2);
        plot(hr(nxLc1), Qr(nxLc1),'x'); hold on;
