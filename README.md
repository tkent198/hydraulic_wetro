...
This repository contains the source code and documentation on the hydraulic modelling of Wetropolis, and builds upon the design model of Bokhove et al. (2020). See also Onno Bokhove's [Wetropolis Github page](https://github.com/obokhove/wetropolis20162020/) which tells the story of Wetropolis from its inception to the present day.
